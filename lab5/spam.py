...
Original file is located at
    https://colab.research.google.com/drive/1Qoow2aKJG_eDsnBY8r_Z7YKP9KxrWwfc?usp=share_link
...
# Grouping the data by the category and then describing the data.
df.groupby('Category').describe()

# Creating a new column called 'Length' and then applying the len function to the 'Message' column.
...
# Applying the text_process function to the first 10 rows of the 'Message' column.
...
# Selecting the 4th message in the dataframe.
message4 = df['Message'][3]
print(message4)

# Transforming the message into a bag of words.
...
fig, ax = plt.subplots()
# Creating an array of the length of the class names.
